...
<body style="font-family: 'Lato', sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <p style="font-size: 18px;">¡Gracias por registrarte! Tu código de verificación es:</p>
    <div style="text-align: center; margin: 30px 0;">
      <span style="font-size: 36px; font-weight: 600; letter-spacing: 5px; color: #446AAB;">{verificationCode}</span>
    </div>
...
<body>
  <div class="header">
    <h1>¡Bienvenid@ a universo explora!</h1>
  </div>
  <div class="content">
    <p>Hola {name},</p>
